                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>
                                : <span
                                    class="badge {{ $quotation['DocumentStatus'] == 'bost_Open' ? 'bg-warning text-white' : 'bg-success text-white' }}">
                        ...
                        <tr>
                            ...
                            <td>
                                : <span
                                    class="badge {{ $quotation['DocType'] == 'dDocument_Items' ? 'bg-secondary text-white' : 'bg-primary text-white' }}">
            ...
            <div class="row">
                <div class="col-md-12">
                            ...
                            <table class="table table-bordered table-hover" id="itemsTable" width="100%" cellspacing="0">
                                ...
                                <tfoot>
                                    <tr class="text-right">
                                        ...
                                        <td><b id="SubTotal">Rp
                                                {{ number_format(array_sum(array_column($quotation['DocumentLines'], 'LineTotal')), 2) }}</b>
                                        </td>
                                    </tr>
                                    <tr class="text-right">
                    ...
                    @else
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="servicesTable" width="100%"
                                cellspacing="0">
                                <thead class="thead-light">
                                    <tr class="text-center">
                                        <th width="5%">No</th>
