...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
            ...
            <div class="col-md-6">
                <div class="row mb-3">
                    <div class="col-md-4 d-flex align-items-center">
                        ...
                        <span class="font-weight-bold ml-5">: {{ $quotation['PeriodIndicator'] }}</span>
                    </div>
                    <div class="col-md-8">
                        <span class="font-weight-bold ml-2">Reference No.</span>
                        <span class="font-weight-bold ml-4">: {{ $quotation['DocNum'] }}</span>
                    </div>
                </div>
                <table class="table table-borderless">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>: {{ $quotation['DocDueDate'] }}</td>
                    </tr>
                    <tr>
                        <td class="font-weight-bold">Document Status</td>
                        <td>
                            : <span class="badge {{ $quotation['DocumentStatus'] == 'bost_Open' ? 'bg-warning text-white' : 'bg-success text-white' }}">
                                {{ $quotation['DocumentStatus'] == 'bost_Open' ? 'Open' : 'Close' }}
                            </span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            : <span class="badge {{ $quotation['DocType'] == 'dDocument_Items' ? 'bg-secondary text-white' : 'bg-primary text-white' }}">
                                {{ $quotation['DocType'] == 'dDocument_Items' ? 'Item' : 'Service' }}
                            </span>
                        </td>
                    </tr>
                </table>
        ...
        <div class="row">
            <div class="col-md-12">
                @if($quotation['DocType'] == 'dDocument_Items')
                <h5 class="font-weight-bold text-primary text-center">Items</h5>
                <div class="table-responsive" style="overflow-x: auto;">
                    <table class="table table-bordered table-hover table-sm" id="itemsTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach($quotation['DocumentLines'] as $item)
                            <tr>
                                <td>{{ $item['ItemCode'] }}</td>
                        ...
                        <tfoot>
                            <tr class="text-right">
                                ...
                                <td><b id="SubTotal">Rp {{ number_format(array_sum(array_column($quotation['DocumentLines'], 'LineTotal')), 2) }}</b></td>
                            </tr>
                            <tr class="text-right">
                                <td colspan="6"><b>Tax</b></td>
                                <td><b id="Tax">Rp {{ number_format($quotation['VatSum'], 2) }}</b></td>
                            </tr>
                            <tr class="text-right">
                                <td colspan="6"><b>Grand Total</b></td>
                                <td><b id="GrandTotal">Rp {{ number_format($quotation['DocTotal'], 2) }}</b></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
                @endif
                @if($quotation['DocType'] == 'dDocument_Service')
                <h5 class="font-weight-bold text-primary text-center">Services</h5>
                <div class="table-responsive" style="overflow-x: auto;">
                    <table class="table table-bordered table-hover table-sm" id="servicesTable" width="100%" cellspacing="0">
                        <thead class="thead-light">
                            <tr class="text-center">
                                <th>Description</th>
                                <th>G/L Account</th>
                        ...
                        <tbody>
                            @foreach($quotation['DocumentLines'] as $service)
                            <tr>
