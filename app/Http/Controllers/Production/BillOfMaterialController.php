...
class BillOfMaterialController extends Controller
{
    ...
    */
    ...
    {
        try {
            $paramsBillOfMaterial = [
                '$select' => 'TreeCode,TreeType,Quantity,Warehouse,ProductDescription',
            ...
            if (empty($billOfMaterials) || !is_array($billOfMaterials)) {
                return view('production.bill-of-material.index', ['billOfMaterials' => [], 'warehouses' => []]);
            }

            // Ambil daftar kode grup unik
            $warehouseCodes = array_unique(array_column($billOfMaterials, 'Warehouse'));
            ...
            return view('production.bill-of-material.index', compact('billOfMaterials', 'warehouses'));
        } catch (\Exception $e) {
            return $e->getMessage();
        }
    }
